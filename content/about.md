...
* [Eileen Yoon (eiln)](https://github.com/eiln), signals guru covering multimedia and accelerators. Eileen worked on on hardware video codec acceleration, after knocking out the Neural Engine and Image Signal Processor (camera).
